    ...
    <div class="row" >
        ...
        <div class="side-menu-fixed" >
            <div class="scrollbar side-menu-bg" >
                <ul class="nav navbar-nav side-menu" id="sidebarnav"  style="background-color: black; margin-top: 70px;">
                    <!-- menu item Dashboard-->
                    <li>
                        <a href="{{ route('admin.dashboard') }}" data-toggle="collapse" data-target="#dashboard">
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#elements">
                            <div class="pull-left"><i class="ti-palette"></i><span
                                    class="right-nav-text">{{trans('main_trans.Itemes')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{ route('admin.items.index') }}">{{trans('main_trans.list_item')}}</a></li>
                           >
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-menu">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">{{trans('main_trans.Cuontries')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="calendar-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('admin.cuontries.index') }}">{{trans('main_trans.Cuontries')}} </a> </li>
                            <li> <a href="{{ route('admin.cities.index') }}">{{trans('main_trans.Cities')}} </a> </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#chart">
                            <div class="pull-left"><i class="ti-pie-chart"></i><span
                                    class="right-nav-text">{{trans('main_trans.serves')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="chart" class="collapse" data-parent="#sidebarnav">
                            <li>  <a href="{{ route('admin.serves.index') }}">{{trans('main_trans.serves_add')}}</a> </li>
                            <li> <a href="{{ route('admin.serve_ps.index') }}">{{trans('main_trans.prudacte')}} </a> </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#font-icon">
                            ...
                            {{trans('main_trans.customar')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="font-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('admin.customars.index') }}">{{trans('main_trans.list_customar')}}</a> </li>
                            <li> <a href="{{ route('admin.customars.create') }}"> أظافة عميل</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="Form" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('admin.users.index') }}">قائمة ألمستخدمين</a> </li>
                            <li> <a href="{{ route('admin.roles.index') }}">قائمة ألصلاحيات</a> </li>
